    ...
    <>
      ...
      <div className="ah-shell">
        ...
        <aside className="ah-sidebar">
          ...
          <Link href="/household" className="ah-nav">
            <span className="ah-nav-icon"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><path d="M9 22V12h6v10"/></svg></span>
            <span className="ah-nav-label">Household</span>
          </Link>
          ...
          <Link href="/client-settings" className="ah-nav">
