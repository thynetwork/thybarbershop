...
export const metadata = {
  title: 'Terms of Service — ThyDriver',
  description: 'ThyDriver terms of service. Rules, responsibilities, and policies for using the platform.',
};
    ...
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column' as const }}>
      ...
      <div className="legal-page">
        ...
        <p className="legal-intro">
          These Terms of Service (&ldquo;Terms&rdquo;) govern your access to and use of the ThyDriver platform, operated by ThyNetwork Inc. (&ldquo;ThyDriver,&rdquo; &ldquo;we,&rdquo; &ldquo;us,&rdquo; or &ldquo;our&rdquo;). By creating an account or using our services, you agree to be bound by these Terms. If you do not agree, do not use the platform.
        </p>

        {/* ── 1. Acceptance of Terms ────────────────────── */}
        <h2 className="legal-heading">1. Acceptance of Terms</h2>
        <p className="legal-body">
          By accessing or using ThyDriver, you confirm that you are at least 18 years of age, that you have read and understood these Terms, and that you agree to be legally bound by them. If you are using ThyDriver on behalf of a business or other entity, you represent that you have the authority to bind that entity to these Terms.
        </p>

        {/* ── 2. Service Description ───────────────────── */}
        <h2 className="legal-heading">2. Service Description</h2>
        <p className="legal-body">
          ThyDriver is a private booking platform that connects independent drivers with their clients (riders). ThyDriver provides the technology platform for scheduling, communication, and coordination between drivers and riders. Key aspects of our service:
        </p>
        <ul className="legal-list">
          <li>ThyDriver is a platform facilitator, not a transportation company. We do not employ, contract, or supervise drivers.</li>
          <li>Drivers on ThyDriver are independent professionals who set their own rates, schedules, and service areas.</li>
          <li>All ride services are provided directly by the driver to the rider. ThyDriver does not provide, guarantee, or insure any transportation service.</li>
        ...
        <p className="legal-body">ThyDriver supports two account types:</p>
        <ul className="legal-list">
          <li><strong>Rider Accounts:</strong> Created by individuals who wish to book rides with drivers on the platform. Riders must have a valid driver code from an active ThyDriver driver to log in, or may use the Find a Driver feature to be matched with a driver.</li>
          <li><strong>Driver Accounts:</strong> Created by independent drivers who wish to use ThyDriver to manage their client bookings, share their driver code, and optionally list in the driver pool.</li>
        </ul>
        ...
        <ul className="legal-list">
          ...
          <li>Notifying ThyDriver immediately if you suspect unauthorized access to your account.</li>
        </ul>

        {/* ── 4. Driver Code System ────────────────────── */}
        <h2 className="legal-heading">4. Driver Code System</h2>
        <p className="legal-body">
          Each driver on ThyDriver is assigned a unique driver code (e.g., IAHJDR4207) that identifies their home airport, initials, and a unique numeric identifier. The driver code system is central to how ThyDriver operates:
        </p>
        <ul className="legal-list">
          ...
          <li><strong>Anti-Poaching Protection:</strong> Driver codes are proprietary to ThyDriver. Riders who discover a driver through the ThyDriver platform (including the driver pool) must book through the platform. Soliciting a driver&rsquo;s personal contact information to circumvent the platform during the pool browsing process is prohibited.</li>
          <li><strong>Code Ownership:</strong> Driver codes remain the property of ThyDriver. Upon account termination, the code is retired and will not be reassigned.</li>
        </ul>

        {/* ── 5. Booking & Payments ────────────────────── */}
        <h2 className="legal-heading">5. Booking &amp; Payments</h2>
        <p className="legal-body">
          ThyDriver facilitates the booking process but does not process ride payments:
        </p>
        <ul className="legal-list">
          ...
          <li><strong>Rates:</strong> Drivers set their own rates. ThyDriver displays rate information as provided by the driver. ThyDriver does not set, negotiate, or guarantee pricing.</li>
          <li><strong>Ride Payments:</strong> All ride payments are made directly between the rider and driver using the driver&rsquo;s preferred payment methods (Zelle, Venmo, Cash App, or cash). ThyDriver does not process, hold, or transfer ride fare payments.</li>
          <li><strong>Platform Fees:</strong> ThyDriver charges platform fees (subscription fees for drivers, matching fees for riders) separately from ride payments. These are processed via Stripe.</li>
        </ul>

        {/* ── 6. Subscription ──────────────────────────── */}
        <h2 className="legal-heading">6. Subscription</h2>
        <p className="legal-body">
          Drivers pay a weekly subscription fee of $9.99 to maintain an active ThyDriver account. Subscription terms:
        </p>
        <ul className="legal-list">
          ...
          <li>ThyDriver reserves the right to change subscription pricing with 30 days&rsquo; advance notice.</li>
        </ul>
        ...
        <p className="legal-body">
          ThyDriver requires all riders and drivers to complete a mutual Safety Protocol before their first ride together. This is a mandatory requirement and cannot be bypassed:
        </p>
        <ul className="legal-list">
          <li>Both parties must submit emergency contact information and identity verification data.</li>
          <li>All Safety Protocol data is encrypted and accessible only to ThyDriver administrators.</li>
        ...
        <p className="legal-body">
          All drivers on ThyDriver must maintain active and valid insurance coverage appropriate to their vehicle class:
        </p>
        <ul className="legal-list">
          ...
          <li>ThyDriver verifies insurance information but does not provide insurance coverage. Drivers are solely responsible for maintaining adequate coverage.</li>
        ...
        <ul className="legal-list">
          ...
          <li>Cancellation fees are settled directly between the rider and driver. ThyDriver facilitates communication but does not collect or enforce cancellation fees.</li>
        ...
        <p className="legal-body">The following conduct is prohibited on ThyDriver and may result in immediate account suspension or termination:</p>
        <ul className="legal-list">
          ...
          <li><strong>Harassment:</strong> Any form of harassment, discrimination, threats, or abusive behavior toward other users, ThyDriver staff, or third parties.</li>
          ...
          <li><strong>Illegal Activity:</strong> Using ThyDriver for any unlawful purpose, including but not limited to transporting illegal goods or engaging in any criminal activity.</li>
        ...
        <p className="legal-body">
          ThyDriver is a technology platform that facilitates connections between independent drivers and riders. To the maximum extent permitted by law:
        </p>
        <ul className="legal-list">
          <li>ThyDriver does not employ, contract, control, or supervise any driver on the platform. Drivers are independent professionals responsible for their own conduct, vehicle maintenance, and compliance with local laws and regulations.</li>
          <li>ThyDriver is not liable for any damages, injuries, losses, or disputes arising from rides arranged through the platform, including but not limited to personal injury, property damage, or financial loss.</li>
          <li>ThyDriver makes no warranties, express or implied, regarding the quality, safety, legality, or reliability of any ride service provided by drivers on the platform.</li>
          <li>ThyDriver&rsquo;s total aggregate liability to you for any claims arising from your use of the platform shall not exceed the total fees you have paid to ThyDriver in the 12 months preceding the claim.</li>
          <li>ThyDriver is not responsible for the actions, omissions, or behavior of any user, whether rider or driver.</li>
        </ul>
        ...
        <ul className="legal-list">
          <li><strong>By You:</strong> You may delete your account at any time through your dashboard settings or by contacting support@thydriver.com. For drivers, any remaining subscription period will not be refunded.</li>
          <li><strong>By ThyDriver:</strong> We reserve the right to suspend or terminate any account at our sole discretion, with or without cause, including but not limited to violations of these Terms, fraudulent activity, safety concerns, or non-payment of fees.</li>
        ...
        <p className="legal-body">
          ThyDriver reserves the right to modify these Terms at any time. When we make material changes, we will provide notice via email or a prominent notice on the platform at least 14 days before the changes take effect. Your continued use of ThyDriver after the effective date constitutes acceptance of the revised Terms. If you do not agree with the changes, you must discontinue use and delete your account.
        </p>
