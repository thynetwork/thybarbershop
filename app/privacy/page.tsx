...
export const metadata = {
  title: 'Privacy Policy — ThyDriver',
  description: 'ThyDriver privacy policy. How we collect, use, and protect your data.',
};
    ...
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column' as const }}>
      ...
      <div className="legal-page">
        ...
        <p className="legal-intro">
          ThyDriver (&ldquo;we,&rdquo; &ldquo;us,&rdquo; or &ldquo;our&rdquo;) is operated by ThyNetwork Inc., headquartered in Houston, Texas. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use the ThyDriver platform, including our website at thydriver.com and any associated mobile applications or services.
        </p>
        ...
        <ul className="legal-list">
          ...
          <li><strong>Safety Protocol Data:</strong> Emergency contact information, identification verification data, and safety acknowledgments submitted by both riders and drivers.</li>
        ...
        <ul className="legal-list">
          <li><strong>Booking Facilitation:</strong> To connect riders with their designated drivers, process booking requests, and display scheduling information.</li>
          ...
          <li><strong>Safety Protocol:</strong> To maintain and enforce our mutual Safety Protocol, including encrypted storage of emergency contact data accessible only to ThyDriver administrators in emergency situations.</li>
          <li><strong>Account Management:</strong> To create and maintain your account, process subscription payments (drivers), and process matching fees (riders using Find a Driver).</li>
        ...
        <p className="legal-body">ThyDriver does not sell, rent, or trade your personal information to third parties. We share information only in the following limited circumstances:</p>
        <ul className="legal-list">
          <li><strong>Between Connected Riders and Drivers:</strong> When a rider and driver are connected via a driver code, limited profile information (name, contact details, vehicle information, and booking details) is shared between the two parties to facilitate the ride.</li>
          <li><strong>Driver Pool Browsing:</strong> Drivers who opt into the public driver pool make limited profile information visible to prospective riders, including name, vehicle class, airport coverage, availability, and rate ranges. Contact information is not displayed during pool browsing.</li>
          ...
          <li><strong>Legal Requirements:</strong> We may disclose information if required by law, subpoena, court order, or government request, or if we believe disclosure is necessary to protect the rights, safety, or property of ThyDriver, our users, or the public.</li>
        </ul>

        {/* ── 4. Safety Protocol Data ───────────────────── */}
        <h2 className="legal-heading">4. Safety Protocol Data</h2>
        <p className="legal-body">
          Our Safety Protocol requires both riders and drivers to submit emergency contact information and identification details before their first ride. This data is treated with the highest level of security:
        </p>
        <ul className="legal-list">
          <li>All Safety Protocol data is encrypted at rest and in transit using industry-standard AES-256 encryption.</li>
          <li>Safety Protocol records are accessible only to authorized ThyDriver administrators.</li>
          <li>Emergency contact information is accessed only in genuine emergency situations or when required by law enforcement.</li>
          <li>Neither riders nor drivers can view each other&rsquo;s Safety Protocol submissions directly. The platform displays only a confirmation that the other party has completed the protocol.</li>
        </ul>

        {/* ── 5. Driver Credentials ─────────────────────── */}
        <h2 className="legal-heading">5. Driver Credentials</h2>
        <p className="legal-body">
          Driver credential information, including the last four digits of driver&rsquo;s license numbers and insurance policy details, is collected to verify that drivers meet ThyDriver&rsquo;s standards. This information is:
        </p>
        <ul className="legal-list">
          <li>Encrypted and stored securely with access restricted to ThyDriver administrators only.</li>
          <li>Never displayed to riders. Riders see only a verification badge confirming the driver&rsquo;s credentials have been reviewed and approved.</li>
        ...
        <p className="legal-body">
          ThyDriver operates as a platform facilitator, not a payment processor for ride fares. It is important to understand our payment model:
        </p>
        <ul className="legal-list">
          <li><strong>Ride Payments:</strong> All ride payments are made directly between the rider and the driver. ThyDriver does not process, hold, collect, or transfer ride fare payments. The payment methods displayed on a driver&rsquo;s profile (Zelle, Venmo, Cash App, etc.) are the driver&rsquo;s own personal accounts.</li>
          <li><strong>Subscription Fees:</strong> Driver subscription fees ($9.99/week) are billed directly via Stripe. ThyDriver stores only the Stripe customer ID and subscription status, not your full card number.</li>
        ...
        <p className="legal-body">
          By creating a ThyDriver account and providing your phone number, you consent to receive SMS/text message notifications related to your account and booking activity. Details:
        </p>
        <ul className="legal-list">
        ...
        <p className="legal-body">ThyDriver uses minimal tracking technologies:</p>
        <ul className="legal-list">
          ...
          <li><strong>No Third-Party Tracking:</strong> ThyDriver does not use third-party advertising trackers, analytics pixels, or social media tracking scripts. We do not build advertising profiles or share browsing data with ad networks.</li>
        </ul>

        {/* ── 10. Children's Privacy ────────────────────── */}
        <h2 className="legal-heading">10. Children&rsquo;s Privacy</h2>
        <p className="legal-body">
          ThyDriver is not intended for use by individuals under the age of 18. We do not knowingly collect personal information from minors. If we become aware that a user is under 18, we will promptly deactivate their account and delete their personal information. If you believe a minor has created an account on ThyDriver, please contact us immediately at support@thydriver.com.
        </p>
        ...
        <ul className="legal-list">
          ...
          <li><strong>Update:</strong> You may update your account information directly through your ThyDriver dashboard, or contact us for assistance with data that cannot be self-edited.</li>
        ...
        <p className="legal-body">
          To exercise any of these rights, contact us at support@thydriver.com. We will respond to your request within 30 days.
        </p>
        ...
        <p className="legal-body">
          We may update this Privacy Policy from time to time. When we make material changes, we will notify you via email or a prominent notice on our platform. Your continued use of ThyDriver after any changes constitutes acceptance of the revised policy. The &ldquo;Last Updated&rdquo; date at the top of this page reflects the most recent revision.
        </p>
